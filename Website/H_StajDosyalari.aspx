<%@ Page Title="" Language="C#" MasterPageFile="~/H_AnaMaster.Master" AutoEventWireup="true" CodeBehind="H_StajDosyalari.aspx.cs" Inherits="Website.H_StajDosyalari" %>
            ...
            <div class="row" >
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="height:900px; " >
                  <div class="x_title">
                    <h2>Staj Dosyaları</small></h2>

                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Aşağıdan staj başvurularını seçip işlem yapabilirsiniz.
                    </p>
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <tbody>
                            ...
                            <asp:ListView ID="listStajDosyalari" runat="server">
                               <ItemTemplate>
                                 <tr>
				   ...
				   <div class="form-group" >
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" style="float:left; margin:auto">
                          <asp:Button ID="btnStajDosyasi" runat="server" CssClass="btn btn_primary" Text="Staj Dosyasını İndir" OnClick="btnStajDosyasi_Click"  /> 
                        </div>
                      </div>
                </div>
              </div>
