...
namespace Website
{
    public partial class H_Bildirimler : System.Web.UI.Page
    {
        ...
        {
            string path = (@"C:\Users\HASAN.KOC\Desktop\server\lisansbahar.pdf"); //serverdan dosya yolu alınıyor.
        ...
        {
            string path = (@"C:\Users\HASAN.KOC\Desktop\server\yazilim.docx"); //serverdan dosya yolu alınıyor.
            string name = Path.GetFileName(path); //dosya ismi alınıyor.
            string ext = Path.GetExtension(path); //dosya uzantısı alınıyor.
            string type = "";
